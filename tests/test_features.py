...
""" * 2).strip()
    ...
    def test_render_bdf_vertical(self):
        ...
        text2 = monobit.render(vert2, b'\x27\x27', direction='top-to-bottom').to_text()
        assert text2 == self.verttext, f'"""{text2}"""\n != \n"""{self.verttext}"""'

    def test_render_yaff_vertical(self):
        vert1, *_ = monobit.load(self.font_path / 'vertical.yaff')
        text1 = monobit.render(vert1, b'\x27\x27', direction='top-to-bottom').to_text()
...
""".strip()
    ...
    def test_render_amiga_proportional(self):
        ...
        text1 = monobit.render(prop1, b'testing').to_text()
    ...
    def test_render_yaff_proportional(self):
        ...
        text2 = monobit.render(prop2, b'testing').to_text()
...
""".strip()
    ...
    def test_render_yaff_kerning(self):
        ...
        text1 = monobit.render(webby_mod1, b'sjifjij').to_text()
    ...
    def test_render_bmf_kerning(self):
        ...
        text2 = monobit.render(webby_mod2, b'sjifjij').to_text()
