...
if Image:
    ...
    def save_image(
        ...
        codepoint_range: first and last codepoint to include (includes bounds and undefined codepoints; default: None)
        """
        if len(fonts) > 1:
        ...
        img = (
            chart(font, columns, margin, padding, order, direction, codepoint_range)
